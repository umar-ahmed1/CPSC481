export const attractionData = {
    ...
    "zipper": {
        ...
        "waitTime": "35 minutes", 
        "image": '../assets/images/zipper-header.png'
    },
    "nashville-north": {
        ...
        "description": "Step into the heart of country music at Nashville North, the ultimate Stampede destination. This lively " +
                       "tent is where the party never stops. Tonights lineup: Ben Chase, Elle King, Koe Wezel, Parker McCollum.", 
        "waitTime": "4 hours", 
    ...
    "show-home": {
        ...
        "waitTime": "1.5 hours", 
        "image": '../assets/images/showhome.jpg'
    },
};
